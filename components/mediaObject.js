  ...
  return (<div className="lg:flex my-6 py-8 blob-t">
        ...
        <div className="lg:w-2/4">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex">
              {code == "" ? <></>: <Link className="mr-3 flex items-center" href={code} target="_blank">
              <svg className="w-8 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" width="64" height="64" viewBox="0 0 128 128" strokeWidth="1.5" stroke="currentColor" >
                <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 6.75L22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3l-4.5 16.5" />
              </svg>
              </Link>}

                 <Link href={url} target="_blank"> <svg className="w-8" x="0px" y="0px" width="64" height="64" viewBox="0 0 128 128">
