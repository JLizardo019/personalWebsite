...
export default function MediaObject({ title, alt, tools, url, image, code, descript}) {  
  ...
  return (<div className="lg:flex my-6 py-4 blob-t">
        <div className="mb-4 lg:w-2/4 sm:mr-4">
          <Image className="border-[var(--c1)] border-4 h-auto w-full" alt ={alt} src={image} width={2880} height={1548} priority="true" ></Image>
        </div>
        <div className="lg:w-2/4">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex">
              ...
              <svg className="w-8" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class="w-6 h-6">
  <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 6.75L22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3l-4.5 16.5" />
</svg>

              </Link>}
                 <Link href={url} target="_blank" className="hover:text-[var(--c2)]"> <svg className="w-7" strokeWidth="1.5" x="0px" y="0px" width="64" height="64" viewBox="0 0 128 128">
          ...
          <p className="text-lg leading-8 my-5 text-gray-600">
            {descript}
          </p>
          {tools.map((item) => (
