...
export default function HomePage() {
    ...
    useEffect(() => { // manage character animations and opening animations
    ...
    return(
        <>
            ...
            <div id="opener" className='w-screen h-screen absolute flex justify-center items-center z-20 top-0 bg-white overflow-hidden'>
                <svg className="" id="animation" data-name="Layer 4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1268.6379 959.0791">
  ...
  <path id="dot" d="m119.0379,222.1769c.52-30.26,45.53-30.26,46.05,0-.52,30.27-45.54,30.26-46.05,0Z" fill="none" stroke="#000" stroke-linecap="round" stroke-miterlimit="10" stroke-width="51"/>
            ...
            <Layout>
                ...
                <Container id="projects" bg="bg-[var(--c1)]">
                    <h2 className="mb-6 text-4xl font-bold tracking-tight text-gray-900">Knowledge in 20+ programming tools and frameworks</h2>
                    
                    <div className='mb-6'>
                    {tools.map((item) => (
                        <Badge2 className="text-center" id={item.id} name={item.name}></Badge2>
                    ))}
                    </div>
                    {/* <Link
                    href="/projects"
                ...
                <Container id ="curriculum" bg="">
                <h2 className="text-4xl font-bold tracking-tight text-gray-900">Over 4 years of teaching experience</h2>

        <div className="flex flex-col justify-between items-center pb-8 lg:flex-row">
        ...
        <div className="mx-auto lg:mx-0">
          ...
          <div className="mt-8 flex items-center gap-x-6">
            ...
            <Link href="/curriculum" className="text-lg mt-4 squiggle font-semibold leading-6 text-gray-900 hover:text-[var(--c2)]">
                ...
                <Container id="testimonials" bg="bg-[var(--c1)]">
        <h2 className="text-4xl font-bold tracking-tight text-gray-900 mx-auto max-w-3xl lg:max-w-7xl mb-8">100% Satisfaction Guaranteed</h2>
