...
export default function CurriculumPage() {
    ...
    return(
        <>
            ...
            <Layout>
                <Container>
                    <h1 className="mt-2 text-center text-5xl font-bold  text-gray-900">Curriculum</h1>

                    <h2 className='text-3xl mt-8 font-bold text-gray-900'>New York University</h2>
                        <Link target="_blank" href="https://cs.nyu.edu/courses/spring23/CSCI-UA.0002-005/"><p className="mt-12 text-xl underline hover:text-[var(--c2)]">CSCI-UA.0002 Introduction to Computer Programming</p></Link>   
                        ...
                        <Link target="_blank" href="https://cs.nyu.edu/courses/spring23/CSCI-UA.0004-005/"><p className="mt-12 text-xl underline hover:text-[var(--c2)]">CSCI-UA.0004 Introduction to Web Design and Computer Principles</p></Link>   
                        ...
                        <Link target="_blank" href="https://itp.nyu.edu/ima/courses/code/"><p className="mt-12 text-xl underline hover:text-[var(--c2)]">IMNY-UT.0001 Code!</p></Link>   
                        ...
                        <Link target="_blank" href="https://itp.nyu.edu/ima/courses/code-2/"><p className="mt-12 text-xl underline hover:text-[var(--c2)]">IMNY-UT.0002 Code! 2</p></Link>   
                    ...
                    <h2 className='text-3xl mt-16 font-bold text-gray-900'>All Star Code</h2>
                        <Link href="https://allstarcode.org/" target="blank"><p className="mt-12 text-xl underline hover:text-[var(--c2)]">Machine Learning with ml5.js Lesson</p></Link>   
                        ...
                        <Link href="https://www.crackthecode.zone" target="_blank"><p className="mt-12 text-xl underline hover:text-[var(--c2)]">Crack the Code: Binary Numbers Lesson</p></Link>   
